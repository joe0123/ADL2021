...
def postprocess_qa_predictions(
    ...
    Args:
        ...
        n_best (:obj:`int`, `optional`, defaults to 20):
            The total number of n-best predictions to generate when looking for an answer.
        max_ans_len (:obj:`int`, `optional`, defaults to 30):
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        for feature_index in feature_indices:
            ...
            # Go through all possibilities for the `n_best` greater start and end logits.
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    if (
                        ...
                        continue
                    # Don't consider answers with a length that is either < 0 or > max_ans_len.
        ...
        # Only keep the best `n_best` predictions.
...
def postprocess_qa_predictions_with_beam_search(
    ...
    Args:
        ...
        features: The processed dataset (see the main script for more information).
        predictions (:obj:`Tuple[np.ndarray, np.ndarray]`):
            The predictions of the model: five arrays containing the start_top_log_probs, start_top_index, 
            end_top_log_probs, end_top_index and cls_logits respectively. Its
            first dimension must match the number of elements of :obj:`features`.
        n_best (:obj:`int`, `optional`, defaults to 20):
            The total number of n-best predictions to generate when looking for an answer.
        max_ans_len (:obj:`int`, `optional`, defaults to 30):
        ...
        start_n_top (:obj:`int`, `optional`, defaults to 5):
            The number of top start logits too keep when searching for the :obj:`n_best` predictions.
        end_n_top (:obj:`int`, `optional`, defaults to 5):
            The number of top end logits too keep when searching for the :obj:`n_best` predictions.
        is_world_process_zero (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether this process is the main process or not (used to determine if logging/saves should be done).
    """
            ...
            for i in range(start_n_top):
                for j in range(end_n_top):
                    ...
                    if (start_index >= len(offset_mapping) or end_index >= len(offset_mapping) \
                        ...
                        continue
                    # Don't consider answers with a length negative or > max_ans_len.
                    if end_index < start_index or end_index - start_index + 1 > max_ans_len:
                        continue
                    # Don't consider answer that don't have the maximum context available (if such information is
                    # provided).
