...
#python train.py --train_file task_data/train_valid_0.json --valid_file task_data/train_valid_1.json --model_name hfl/chinese-electra-180g-base-discriminator --lr 1e-4 --grad_accum_steps 8
...
#python train.py --train_file task_data/train_0.json --model_name hfl/chinese-electra-180g-base-discriminator --lr 1e-4 --grad_accum_steps 8

#python make_data.py -q ../dataset/public.json -c ../dataset/context.json -o public
python make_data.py -q ../RelChoice/results.json -c ../dataset/context.json -o public
python predict.py --test_file task_data/public_0.json --target_dir saved/roberta
