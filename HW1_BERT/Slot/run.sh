...
#python make_data.py -i ../datasets/slot/train.json ../datasets/slot/eval.json -o all -d task_data
#python train.py --train_file task_data/all.json --model_name bert-base-uncased


python make_data.py -i ../datasets/slot/test.json -o test -d task_data
